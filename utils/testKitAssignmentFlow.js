  ...
  try {
    ...
    if (sampleDiscente.kitAssignments.length > 0) {
      ...
      sampleDiscente.kitAssignments.forEach((assignment, index) => {
        ...
        console.log(`      Kit Number: ${assignment.kitNumber || 'NOT ASSIGNED'}`);
    ...
    console.log('   1. Tracking assignments without kit numbers should exist for active courses');
    console.log('   2. Kit number assignments should update existing tracking assignments');
    console.log('   3. Expiration checking should work with both types of assignments');
    console.log('');
    ...
    console.log(`   Tracking assignments (no kit number): ${trackingAssignments.length}`);
    console.log(`   Kit number assignments: ${kitNumberAssignments.length}`);
    console.log(`   Total assignments: ${sampleDiscente.kitAssignments.length}`);
    console.log('');
